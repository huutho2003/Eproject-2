...
public class QuanLySach extends JFrame 
{
	...
	public QuanLySach(String tieude)
	{
	...
	private void addEvents() 
	{
		...
		btnThem.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				uit.edu.vn.eventqlsach.Them themsach  = new uit.edu.vn.eventqlsach.Them("Thêm sách");
				themsach.showWindow();
				dtmSach.setRowCount(0);
				hienThiSach();
			}
		...
		btnTimKiem.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				uit.edu.vn.eventqlsach.TimKiem timsach  = new uit.edu.vn.eventqlsach.TimKiem("Tìm kiếm thông tin sách");
				timsach.showWindow();
				dtmSach.setRowCount(0);
				hienThiSach();
			}
		...
		btnSua.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				uit.edu.vn.eventqlsach.Sua suasach = new uit.edu.vn.eventqlsach.Sua("Sửa thông tin sách");
		...
		btnXoa.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				uit.edu.vn.eventqlsach.Xoa xoasach = new uit.edu.vn.eventqlsach.Xoa("Xóa thông tin sách");
